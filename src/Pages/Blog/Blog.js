        ...
        <div className='h-screen w-screen flex justify-center items-center'>
            ...
            <div>
                ...
                <div class="absolute top-1/2 left-1/2 -mt-4 -ml-2 h-8 w-4 text-indigo-700">
                    ...
                    <div class="absolute top-4 h-5 w-4 animate-bounce border-l-2 border-gray-200" ></div>
                    <div class="absolute top-4 h-5 w-4 animate-bounce border-r-2 border-gray-200" ></div>
                </div>
            </div>
        </div>
    );
